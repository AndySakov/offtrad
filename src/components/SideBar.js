...
const SideBar = () => {
  ...
  return (
    <div className="sideBar">
      ...
      <ul>
        <li><div className="text-with-icon"><FontAwesomeIcon className="icon" icon="home" size="1x" /> <NavLink to='/' className='navText' activeClassName='activeNav' >Home</NavLink></div></li>
