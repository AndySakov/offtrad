  ...
  return (
    <div className="navBar">
      ...
      <ul>
        ...
        <li><div className="text-with-icon"><FontAwesomeIcon className="icon" icon="search" size="1x" /> <NavLink to='/search' className='navText' activeClassName='activeNav' >Search</NavLink></div></li>
