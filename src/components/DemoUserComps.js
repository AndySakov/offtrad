...
const DemoUserComps = ({ modalTrigger, modalRef, side, handleLogin, handleSignup }) => {
  return (
    <>
      ...
      <CustomModal ref={modalRef}><ModalContent login={side} handleLogin={(e) => handleLogin(e)} handleSignup={(e) => handleSignup(e)} refr={modalRef} /></CustomModal>
    </>
  )
}
